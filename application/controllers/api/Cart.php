	...
	{  
        ...
        if(isset($items["product_color_size"])){
          ...
          $output .= '
            ...
            $link= '<a href="#" class="ajaxbook_form fancybox.ajax" data-fancybox data-type="ajax" data-src="'. base_url().'restaurants/order_form/'.$items['cuisine_productid'].' "data-toggle="tooltip" title="Edit!" id="'.$items["rest"].'">
                        <i class="fa fa-pencil-square-o" style="color: green;cursor: pointer;"></i>
                    </a>
                    ';
          $output .= '
