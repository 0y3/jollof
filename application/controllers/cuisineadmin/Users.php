...
class Users extends CI_Controller {
    ...
    public function index($page=0)
    {
        ...
        $this->session_manager->validateCuisine("Admin::users");
        //print_r($_SESSION);
    ...
    public function addform()
    {
        ...
        $data['breadCrumbs'] = '<li class="breadcrumb-item"><a href="'.site_url("cuisineadmin/users").'">Users</a></li> <li class="breadcrumb-item active">Add User</li>';
        $data['mainmenu'] = "users";
        $this->load->view('cuisine_admin/layout', $data);
    }
    ...
    public function editform($id=null)
    {
        ...
        if(!empty($id) )
        {
            ...
            $data['breadCrumbs'] = '<li class="breadcrumb-item"><a href="'.site_url("cuisineadmin/users").'">Users</a></li> <li class="breadcrumb-item active">Edit User</li>';
            $data['mainmenu'] = "users";
            $this->load->view('cuisine_admin/layout', $data);
        }
        else
