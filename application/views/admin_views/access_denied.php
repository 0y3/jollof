...
<head>
  ...
  <link rel="shortcut icon" href="<?=base_url()?>assets/dist/img/avatar.png" />
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>GSK</b>PALS Admin</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Access Denied
        <small>Permissin required</small>
      </h1>
    ...
    <section class="content">
      ...
      <div class="row">
      	Access denied. You do not have access to the resourse you are requesting.
      </div>
      <!-- End of content -->
...
<script src="<?=base_url()?>assets/dist/js/pages/dashboard.js?<?=strtotime(date("Y-m-d H:i:s"))?>"></script>
<?php } ?>

<?php if(isset($mainmenu) && $mainmenu == 'transactions') { ?>
<script src="<?=base_url()?>assets/dist/js/pages/transactions.js?<?=strtotime(date("Y-m-d H:i:s"))?>"></script>
<?php } ?>

<?php if(isset($mainmenu) && $mainmenu == 'orangecards') { ?>
<script src="<?=base_url()?>assets/dist/js/pages/orangecards.js?<?=strtotime(date("Y-m-d H:i:s"))?>"></script>
<?php } ?>

<!-- ChartJS 1.0.1 -->
<script src="<?=base_url()?>assets/plugins/chartjs/Chart.min.js"></script>

<script src="<?=base_url()?>assets/dist/js/validator/jquery.form-validator.min.js"></script>
<script src="<?=base_url()?>assets/dist/js/jqvalidation/jquery.validate.js"></script>
