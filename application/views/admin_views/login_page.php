...
<head>
  ...
  <title>Jollof Cuisine Admin | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><img src="<?=base_url()?>admin_assets/dist/img/login.png" class="img-circle" alt="User Image"></b>Jollof Admin Login</a>
  </div>
  <!-- /.login-logo -->
