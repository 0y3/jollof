...
<head>
    ...
    <title>Jollof Cuisine Admin | Access Denied</title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?=site_url("cuisineadmin/dashboard")?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
