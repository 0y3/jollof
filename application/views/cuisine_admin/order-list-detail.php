                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class=""><?= date('jS M \, Y \ g:i A', strtotime($orderinfo[0]['createdat'])); ?> </h4>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                                    ...
                                    <table id="zero_config" class="table table-bordered">
                                        ...
                                        <?php
                                            ...
                                            if($orderinfo[0]['status']==1)
                                            {
                                                ...
                                                {
                                                    $action .='
                                                        <a href="'.site_url("cuisineadmin/orders/cancel_orderform").'" id="ord_can" data-get="'.$orderinfo[0]['id'].'" data-orderid="'.$orderinfo[0]['ordercode'].'" data-toggle="modal"  data-target="#modal_cancel" data-container="modal_cancel" title="Cancel Order" class="ord_can btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                                        ';
                                                }
                                                $status="warning";
                                                /*
                                            ...
                                            elseif($orderinfo[0]['status']==2)
                                            {
                                                ...
                                                {
                                                $action .='
                                                        <a href="javascript:void(0)" id="ord_del" data-get="'.$orderinfo[0]['id'].'" data-toggle="tooltip" title="Move to Dispatched" class="ord_del btn btn-sm btn-info"><i class="fa fa-road"></i></a>
                                                        ';
                                                }
                                            }
