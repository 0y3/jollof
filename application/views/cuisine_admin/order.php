...
<style>
    td{
                    ...
                    <?php
                        if ( file_exists( APPPATH.'views/'.$page_loader.'_nav.php' ) ) 
                        {
                            
                            $this->load->view('restaurant_admin/order_nav'); // order tray
                        }
                        else 
                        {
                            show_error('Unable to load the requested file: ' . $page_loader.'_nav.php');
                        }
                    ?>
                </div>
...
<script >
      ...
      var dataTable = $('#order_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= site_url('restaurant_admin/get_order'); ?>",
                type:"POST"
           },  
           "columnDefs":[  
                {  
