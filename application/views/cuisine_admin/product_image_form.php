                    ...
                    <div class="modal-dialog mmodal-width modal_dialog_edit" style=" margin-top: 60px; ">
                        ...
                        <div class="modal-content modal-center" style="">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="cate_form" action="<?= site_url('fashion_admin/productimagesave') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                   ...
                   success:function(data)
                        {
                            ...
                            if(data.status === '1' )
                            {
                                ...
                                $('#modal_image').modal('hide'); 
                                    ...
                                    content: 'Success! Product Image:  Added',
                                    delayOnHover: true,
                                    showCountdown: true,
                                    closeButton: true
                                });
