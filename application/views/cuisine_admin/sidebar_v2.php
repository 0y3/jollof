                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            ...
                            <div class="user-profile dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-t-10">
                                    ...
                                    <a href="<?=site_url('cuisineadmin/authentication/logout')?>" title="Logout" class="btn btn-circle btn-sm">
                        ...
                        <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="dashboard") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/dashboard')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                       	  ...
                       	  <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="orders") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/orders')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                       	  ...
                       	  <?php if($this->session_manager->hasPermission("Categories::index")) {?>
                       	  <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="Categories") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/categories')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                       			<i class="icon-Puzzle"></i> 
                       			<span class="hide-menu">Manage Menu Categories</span>
                       		</a>
                       	  </li>
                       	  <?php } ?>
                          ...
                          <a href="<?=site_url('cuisineadmin/products')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                            <i class="icon-Puzzle"></i> 
                          ...
                          <?php if($this->session_manager->hasPermission("Admin::table_reservation")) {?>
                          <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="tablereservation") echo " selected";?>">
                          <a href="<?=site_url('cuisineadmin/tablereservation')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                            <i class="icon-Puzzle"></i> 
                          ...
                          <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="users") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/users')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                          ...
                          <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="promos") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/promos')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                       			<i class="icon-Business-ManWoman"></i> 
                       	  ...
                       	  <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="settings") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/dashboard/settings')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                        ...
                        <?php } ?>
                          ...
                          <li class="sidebar-item<?php if(isset($mainmenu) && $mainmenu=="changepassword") echo " selected";?>">
                       		<a href="<?=site_url('cuisineadmin/dashboard/changepasswordform')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
                          ...
                          <li class="sidebar-item">
                       		<a href="<?=site_url('cuisineadmin/authentication/logout')?>" class="sidebar-link waves-effect waves-dark sidebar-link">
