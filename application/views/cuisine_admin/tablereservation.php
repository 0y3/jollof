				...
				<div>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>          
                                            <tr>
                                                <td><?=date("jS M \, Y \ g:i A", strtotime($user['createdat']))?></td>
                                                ...
                                                <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="col-md-12 controllabel" for="save_note">Cancellation note <label class="text-danger">*</label> </label>
                                ...
                                <script>  
                                    ...
                                    $(document).on("click",".table_accept", function(e){
                                       e.preventDefault();
                                       ...
                                       var s_Id = $(this).data('get');
                                           ...
                                           $('.preloader').css("display", "block");
                                            $.ajax({
                                                    type: "POST",
                                                    url: site_url+'cuisineadmin/tablereservation/add/'+s_Id,
                                                    dataType: 'json',
                                                    data: {
                                                            table:'accept',
                                                            _id: s_Id
