                    ...
                    <div class="block full">
                        ...
                        <div class="block-title">
                            ...
                            <div class="block-options pull-right">
                                ...
                                <a href="<?= site_url('fashion_admin/loaduser') ?>" class="btn btn-sm btn-default" data-toggle="modal" data-tooltip="tooltip" data-target="#modal_cate" data-container="modal_cate" title="Add New Slider " style="background-color:#1bbae1; color: #FFF">
...
<script >
      ...
      var dataTable = $('#order_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= site_url('fashion_admin/user_table'); ?>",
                type:"POST"
           },  
           "columnDefs":[  
                {  
...
<script>
    ...
    $(document).on("click",".user_del", function(e){
       ...
       confirmDialog_cart(msgg, function(){
            $.ajax({
                    type: "POST",
                    url: '<?= site_url('fashion_admin/deleteuser') ?>',
                    dataType: 'json',
                    data: {
                            _id: s_Id,
                            _name: s_name
