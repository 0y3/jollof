                                        ...
                                        <div class="ml-auto">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info" data-toggle="dropdown" 
                                                	aria-haspopup="true" aria-expanded="false" onclick="window.location='<?=site_url("cuisineadmin/users/addform")?>'">
                                                    Create New
                                                </button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?=site_url("cuisineadmin/users/editform/".$user['id'])?>" data-toggle="tooltip" data-get="<?=$user['id']?>" title="Edit" class="btn btn-sm btn-light-info"> <i class="fa fa-edit"></i></a>
                                                    ...
                                                    <a href="<?=site_url("cuisineadmin/users/resendactivationemail/".$user['id'])?>" id="" data-toggle="tooltip" data-get="<?=$user['id']?>"  title="Resend Activation Email" class="btn btn-sm btn-default send_email"> <i class="fa fa-envelope"></i></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php
