...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" href="<?=base_url()?>assets_v2/assets/images/favicon.png">
    <title>Jollof Fashion Admin | Access Denied</title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?=site_url("fashionadmin/dashboard")?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
