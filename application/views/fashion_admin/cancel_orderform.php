                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-content ">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="ordercancel_form" action="<?= site_url('fashionadmin/orders/update_orderflow') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
