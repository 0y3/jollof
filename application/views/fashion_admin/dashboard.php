                                    ...
                                    <tbody>
                                        ...
                                        <?php if(!empty($recentorders)): ?>
                                            ...
                                            <?php
                                                ...
                                                if(!empty($recentorder['productfrontimage'])){
                                                    $products_img= $recentorder['productfrontimage'];
                                                }
                                                else if (!empty($recentorder['product_image'])) {
                                                    
                                                    $products_img= $recentorder['product_image'][0]['imagename'];
                                                }
                                                else{
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="m-r-10">
                                                        <a class="btn btn-circl" title="<?= $recentorder['productname'] ?>">
                                                            <img src="<?=site_url('assets/uploads/fashion_prod/'.$products_img) ?>" alt="" class="rounded-circle" width="45">
                                                        </a>
                                                    </div>
                                                    <div class="">
                                ...
                                <!--<div class="d-flex flex-row comment-row m-t-0">
                                    ...
                                    <div class="comment-text w-100">
                                        ...
                                        <div class="comment-footer">
                                            <span class="text-muted float-right"><?=date("jS M \, Y \ g:i A", strtotime($recentproblem['createdat']))?></span>
                                ...
                                <div class="table-responsive">
                                    <table class="table v-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                if(!empty($topsell['productfrontimage'])){
                                                    $products_img= $topsell['productfrontimage'];
                                                }
                                                else if (!empty($topsell['product_image'])) {
                                                    
                                                    $products_img= $topsell['product_image'][0]['imagename'];
                                                }
                                                else{
                                                    $products_img= 'product_img_1.jpg';
                                                }
