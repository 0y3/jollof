...
<head>
    ...
    <meta name="twitter:creator" content="Jollof" />
    <meta name="twitter:title" content="Jollof Fahion Admin Panel">
    <meta name="twitter:description" content="">
    <meta name="twitter:image" content="<?= base_url() ?>assets/img/jollof_logo_2.png">

    <!-- Preview Thumbnail Images For Your Website  -->
    <meta property="og:site_name" content="Jollof"/>
    <meta property="og:title" content="Jollof Fahion Admin Panel"/>
    <meta property="og:description" content=""/>
    <meta property="og:image" content="<?= base_url() ?>assets/img/jollof_logo_2.png">
    <meta property="og:url" content="<?= base_url('fashionadmin') ?>"/>

    <!-- Favicon icon -->
    <link rel="icon" type="image/ico" href="<?=base_url()?>assets_v2/assets/images/favicon.ico">
    <title>Jollof Fahion Admin Panel</title>
    <!-- Custom CSS -->
...
<style>
   .ajax-loader {
    ...
    #variant_order,#variant_name,#color_name,#prdprice_order {
        width:100px; 
    }
    #variant_order input,#variant_name input, #color_name input, #prdprice_order input{
        float: left;
        width:100px; 
    }
    #variant_order a,#variant_name a,#color_name a, #prdprice_order a{
        float: left;
        width:40px; 
    }
    #variant_name,#variant_order,#variant_discount, #variant_status,#color_name,#prdprice_order {
        position: absolute;
        display:none;
    }
</style>
    ...
    <?php
        ...
        else
        {
            ...
            else if(!isset($_SESSION['forcechangepassword']) ||  $_SESSION['forcechangepassword'] == '1')
            {
                ...
                redirect('fashionadmin/dashboard/changepasswordform', 'refresh');   
                }
            }
        }
    ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <?php 
                                	...
                                	{
                                ?>  
                                <img src="<?=base_url()?>assets/uploads/fashion_logo/<?=$this->session->avatar?>" alt="user" class="rounded-circle" width="31">
                                <?php 
                                	}
                                	else 
                                	{
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    <div class="">
                                        ...
                                        <?php 
                                        	...
                                        	{
                                        ?>  
                                        <img src="<?=base_url()?>assets/uploads/fashion_logo/<?=$this->session->avatar?>" alt="user" class="img-circle" width="60">
                                        <?php 
                                        	}
                                        	else 
                                        	{
                                ...
                                <a class="dropdown-item" href="<?=site_url("fashionadmin/dashboard/myaccount")?>">
                                    <i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                                
                                <a class="dropdown-item" href="<?=site_url('fashionadmin/dashboard/changepasswordform')?>">
                                    <i class="ti-wallet m-r-5 m-l-5"></i> Change Password</a>
                                
                                <div class="dropdown-divider"></div>
                                
                                <a class="dropdown-item" href="<?=site_url("fashionadmin/dashboard/settings")?>">
                                    <i class="ti-settings m-r-5 m-l-5"></i> Store Setting</a>
                                
                                <div class="dropdown-divider"></div>
                                
                                <a class="dropdown-item" href="<?=site_url('fashionadmin/authentication/logout')?>">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="<?=site_url('fashionadmin/dashboard')?>">Home</a>
                                    </li>
...
<div id="color_name">
    ...
    <script src="<?=base_url()?>assets_v2/custom_js/orders.js"></script>    
    <?php } ?>
        ...
        // get last month dognut chat
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ['Product', 'Number'],  
                          <?php
                          if(!empty($lastmouthsales))
                          {
                            foreach ($lastmouthsales as $lastmouthsale)  
                            {  
    ...
    <script src="<?=base_url()?>assets_v2/custom_js/promos.js"></script>    
    <?php endif; ?>
    ...
    <script src="<?=base_url()?>assets_v2/custom_js/settings.js"></script>
    <script>
