...
<body class="login-img2-bodyme">
    ...
    <div class="container">
        ...
        <?=form_open("fashionadmin/authentication/login_validation", array("class"=>"login-form", "id"=>"login_form"))?>  
        
        <div class="login-wrap">
            <h2 class="text-center login-imgme"> Fashion Login<i class="icon_lock_alt login_imgme_icon"></i></h2>
                    ...
                    if(data =='logged_inn')
                     ...
                     else
                     {
                ...
                }).done(function(data)
                        {
                            ...
                            {
                                //alert('welcome success' + data); 
                                window.location.href='<?php echo base_url() ?>fashionadmin/dashboard';
