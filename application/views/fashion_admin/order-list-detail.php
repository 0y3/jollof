                                    ...
                                    <table id="zero_config" class="table table-bordered">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?=$orderinfo[0]['productname']?></td>
                                                <td>
                                                    <small class="text-muted">Color </small>
                                                    <h6><?=$orderinfo[0]['color']?></h6>
                                                    
                                                    <small class="text-muted p-t-20 db">Size</small>
                                                    <h6><?=$orderinfo[0]['size']?></h6>
                                                    
                                                    <?php if(!empty($orderinfo[0]['note'])) :?> 
                                                    <small class="text-muted p-t-20 db">Note</small>
