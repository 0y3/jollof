                                ...
                                <div class="row m-t-40">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("fashionadmin/orders")?>">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("fashionadmin/orders?orderstatus=1")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("fashionadmin/orders?orderstatus=2")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("fashionadmin/orders?orderstatus=3")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("fashionadmin/orders?orderstatus=4")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("fashionadmin/orders?orderstatus=5")?>">
                                        <div class="card card-hover">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                        	<?=form_open("fashionadmin/orders/",' id="serachform"')?>
                                                           ...
                                                           if($orderitem['status']==1)
                                                            {
                                                                ...
                                                                {
                                                                    $action .='
                                                                        <a href="'.site_url("fashionadmin/orders/cancel_orderform").'" id="ord_can" data-get="'.$orderitem['id'].'" data-orderid="'.$orderitem['ordercode'].'" data-toggle="modal"  data-target="#modal_cancel" data-container="modal_cancel" title="Cancel Order" class="ord_can btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                                                        ';
                                                                }
                                                                $status="warning";
                                                                /*
                                                            ...
                                                            elseif($orderitem['status']==2)
                                                            {
                                                                ...
                                                                {
                                                                $action .='
                                                                        <a href="javascript:void(0)" id="ord_del" data-get="'.$orderitem['id'].'" data-toggle="tooltip" title="Move to Dispatcheds" class="ord_del btn btn-sm btn-info"><i class="fa fa-road"></i></a>
                                                                        ';
                                                                }
                                                            }
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$orderitem['id']?></td>
                                                <td><a href="<?= site_url('fashionadmin/orders/view/'.$orderitem['id'])?>"><?=$orderitem['ordercode']?></a></td>
                                                <td><?=$orderitem['productname']?></td>
                                                <td><?=$orderitem['quantity']?></td>
                                                <td><span class="label label-<?=$status?>"><?=$orderitem['orderstatus_desc']?> </span></td>
                                                <td>
                                                    <a href="<?= site_url('fashionadmin/orders/view/'.$orderitem['id'])?>" id="" data-get="<?=$orderitem['id']?>" data-toggle="tooltip" title="View Order Details" 
