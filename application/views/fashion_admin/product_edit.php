...
<form id="product_form" action="<?= site_url('fashionadmin/products/edit/'.$productid) ?>" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php if(!empty($product_variant['colorimage'])): ?>
                                                                                ...
                                                                                <span data-toggle="tooltip" data-original-title="click to change image" >
                                                                                <?php if($product_variant['colorname'] == 'White'): ?>
                                                                                <a href="javascript:void(0);" data-toggle="modal" data-target="#createmodel" ><img src="<?=site_url('assets/uploads/fashion_prod/thumbs/').$product_variant['colorimage']?>" alt="$product_variant['colorimage']" class="rounded-circle" width="30" /> 
                                                                            ...
                                                                            <?php else: ?>
                                                                                <div  style="position:absolute;">
                                                                                     <span data-toggle="tooltip" data-original-title="click to change image" >
                                                                                    <?php if($product_variant['colorname'] == 'White'): ?>
                                                                                        <a href="javascript:void(0);"data-toggle="modal" data-target="#createmodel" >
    ...
    <div class="modal-dialog modal_dialog_edit" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="productimg_form" action="<?= site_url('fashionadmin/products/productimagesave/'.$productid) ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
