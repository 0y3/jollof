        ...
        <div class=" col-md-12">
            ...
            <hr>
                ...
                ?>
                <form id="promo_data" action="<?= site_url('fashionadmin/promos/'.$action) ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control c_date startdate" type="text" name="promo_date" id="datepromo" value="<?php if(isset($promoinfo)) echo date('d-m-Y',strtotime($promoinfo->startdate))?>" required="">
                                <small ><b>End Date</b> </small>
                                <input name="" type="text" value="<?php if(isset($promoinfo)) echo date('d-m-Y',strtotime($promoinfo->enddate))?>" class="form-control enddate" required="" readonly="" disabled="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div id="crop_imagediv">
                                    ...
                                    <div class="promo_saveimg" style=" position: relative;">
                                        <?php if(isset($promoinfo)): ?>
                                            <img id="Viewcrop_banner" class="Viewcrop_banner" src="<?=site_url('assets/jollof_banners/fashion_banner/'.$promoinfo->imagename) ?>">
