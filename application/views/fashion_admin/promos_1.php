                                    ...
                                    <table id="promo_config" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= site_url('assets/jollof_banners/fashionhompage_banner/'.$promo['imagename'])?> " data-fancybox="images-preview" data-toolbar="false" data-small-btn="true" >
                                                        <img class="db_prdimg" src="<?= site_url('assets/jollof_banners/fashionhompage_banner/'.$promo['imagename'])?>" >
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="" id="" data-toggle="tooltip" data-get="<?=$promo['id']?>" data-name="<?=$promo['imagename']?> " title="Delete" class=" btn btn-sm btn-danger promo_del"> <i class="fa fa-times"></i></a>
                                            ...
                                            ?>
                                            <tr>
                                                <td class="text-center" colspan="7"><b>No Promo Created</b></td>
                                            </tr>
                                            <?php
                                                    }
                                            ?>
