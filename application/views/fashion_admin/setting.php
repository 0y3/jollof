    ...
    .Gp_rmv {
        ...
        cursor: pointer;
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="">
                            <form id="rest_data"  action="" method="post" class="prd_form form-horizontal form-bordered" enctype="multipart/form-data">
                                <div class="card-body">
                                ...
                                <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="Name" name="store_phone1" class="cu_phone_js form-control" placeholder="" value="<?= $rest_info->phone ?>" required>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group has-danger">
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="logo_UploadView">
                                                                    ...
                                                                    <img class="UploadView" src="<?= base_url()?>assets/uploads/fashion_logo/<?= $rest_info->logo ?>" width="100%" height="100%">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!--/row-->
                                        <div>
                                            <input type="hidden" name="latitude" id="latitude"  value="<?= $rest_info->latitude ?>" required="" readonly />
                                            <input type="hidden" name="longitude" id="longitude"  value="<?= $rest_info->longitude ?>" required="" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="card-body">
                                            <button type="submit" id="location_savee" class="btn btn-success"> <i class="fa fa-check"></i> Update</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
