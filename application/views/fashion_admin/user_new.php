        ...
        <div class=" col-md-12">
            <h3 class="modal-title text-left"><b><?=$title_type ?> </b></h3>
                ...
                ?>
                <form id="cate_form" action="<?= site_url('fashionadmin/users/'.$action) ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            ...
                            <select name="status" id="slider_type" class="form-control" required="">
                                 <option value="">Choose User Type..</option>
                                 <option value="1" <?php if($userinfo->status==1 ) echo 'selected' ?>>Active</option>
                                 <option value="0" <?php if($userinfo->status==0 ) echo 'selected' ?>>In-Active</option>
