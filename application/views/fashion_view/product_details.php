            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li><a href="<?= site_url('fashion/store/'.$store_url)?>"><?= $prd['storename']?></a> <i class="ion-ios-arrow-right"></i></li>
            ...
            <div class="container">
                <div class="description-review-wrapper">
                    <div class="description-review-topbar nav text-center">
                        ...
                        <a class="" data-toggle="tab" href="#des-details2">MORE INFORMATION</a>
...
<!-- Modal confirm Empty Cart -->
    ...
    <script>
        ...
        $('.description-review-topbar a').click(function (e) {
          $('.description-review-topbar a.active').removeClass('active');
