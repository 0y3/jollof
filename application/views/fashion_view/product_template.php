        ...
        <div class="shop-wrapper gray-bg pb-80">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 sidebar_big">
                        <!-- Sidebar Filter -->
                        <?php
                            if(isset($sidebar_loader))
                            {
                                if ( file_exists( APPPATH.'views/'.$sidebar_loader.'.php' ) ) 
                                {
                                    $this->load->view($sidebar_loader); // Sidebar tray
                                }
                                else 
                                {
                                    $this->load->view($error_page); //error page
...
<nav id="slide-menu">
    <div class="icon-btn slide-close"><i class="faa fa-closee ion-close"></i></div>
    <div class="menu">
        ...
        <!-- Sidebar Filter -->
        <?php
            if(isset($sidebar_mobile_loader))
            {
                if ( file_exists( APPPATH.'views/'.$sidebar_mobile_loader.'.php' ) ) 
                {
                    $this->load->view($sidebar_mobile_loader); // Sidebar tray
                }
                else 
                {
                    $this->load->view($error_page); //error page
