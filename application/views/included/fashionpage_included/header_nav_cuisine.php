                                ...
                                <div class="main-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="mega-menu-position"><a href="javascript:void(0)">Place An Order</a>
                                                <?php if(!empty($nav)): ?>
                                                <ul class="mega-menu">
                                                    <?php foreach ($nav as $cusine_list) :?>
                                                    <li>
                                                        <ul>
                                                            <li><a href="<?= site_url("cuisine/restaurants/placeorder/$cusine_list->slug"); ?>"><?= $cusine_list->categoryname ?></a></li>
                                                        </ul>
                                                    </li>
                                                    <?php endforeach;?>
                                                </ul>
                                            ...
                                            <li><a href="<?= site_url('cuisine/restaurants'); ?>">All Restaurants</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                                ...
                                <div class="mobile-menu">
                                    <nav id="mobile-menu-active" style="display: block;">
                                        <ul class="menu-overflow">
                                            ...
                                            <li><a href="javascript: void(0)">Place An Orders</a>
                                                <?php if(!empty($nav)): ?>
                                                <ul>
                                                    <?php foreach ($nav as $cusine_list) :?>
                                                    <li><a href="<?= site_url("cuisine/restaurants/placeorder/$cusine_list->slug"); ?>"><?= $cusine_list->categoryname ?></a></li>
