...
<div class="shop-sidebar">
    <div class="shop-catigory-wrapper mb-55">
        <h4 class="shop-catigory-title">Store Categories</h4>
        <div class="shop-catigory">
            <ul id="faq">
                ...
                <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-<?= $navs['id']?>"><?= $navs['categoryname']?> <i class="ion-ios-arrow-down"></i></a>
