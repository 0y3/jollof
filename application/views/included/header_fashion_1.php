                    ...
                    <nav role="navigation" class="f_left f_xs_none d_xs_none">	
                        ...
                        <ul class="horizontal_list main_menu clearfix">
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Women's Clothing <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
					...
					<li class="col-sm-3">
                                         ...
                                         <li class="col-sm-2">
                                             <ul class="sub_menu">
                                                    ...
                                                    <li><a href="#" class="color_dark tr_delay_hover">ACCESSORIES</a>
                                                    <li><a href="#" class="color_dark tr_delay_hover">BAGS</a>
                                                    <li><a href="#" class="color_dark tr_delay_hover">CLOTHING</a>
                                                    <li><a href="#" class="color_dark tr_delay_hover">FASHION JEWELRY</a>
                                                    <li><a href="#" class="color_dark tr_delay_hover">FINE JEWELRY</a>
                                                    <li><a href="#" class="color_dark tr_delay_hover">LINGERIE</a>
                                                    <li><a href="#" class="color_dark tr_delay_hover">SHOES</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">SPORTS & LIFESTYLE</li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">SWIM WEAR</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">WRIST WATCHES</a></li>  
                                                    <li class="divider"></li>
						</ul>
					</li>
                                        ...
                                        <li class="col-sm-2">
                                            <ul class="sub_menu">
                                                    <li class="dropdown-header">Much more</li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Easy to Customize</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Calls to action</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Custom Fonts</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Slide down on Hover</a></li> 
                                                    <li class="divider"></li>
						</ul>
					</li>
                                        ...
                                        <li class="col-sm-2">
                                            <ul class="sub_menu">
                                                    ...
                                                    <li><a href="#" class="color_dark tr_delay_hover">Auto Carousel</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Carousel Control</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Left & Right Navigation</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Four Columns Grid</a></li>
                                                    <li class="divider"></li>
                                                </ul>
					</li>
					<li class="col-sm-2">
                                            <ul class="sub_menu">
                                                    ...
                                                    <li><a href="#" class="color_dark tr_delay_hover">Navbar Inverse</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Pull Right Elements</a></li>
                                                    <li><a href="#" class="color_dark tr_delay_hover">Coloured Headers</a></li>                            
                                                    <li><a href="#" class="color_dark tr_delay_hover">Primary Buttons & Default</a></li>	
                                                    <li class="divider"></li>
						</ul>
					</li>
					<li class="col-sm-2">
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Men's Clothing <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
				<ul class="dropdown-menu mega-dropdown-menu">
					<li class="col-sm-3">
						...
						<ul>
                                                    ...
                                                    <li><a href="#">FASHION JEWELRY</a>
                                                    <li><a href="#">FINE JEWELRY</a>
                                                    <li><a href="#">LINGERIE</a>
                                                    <li><a href="#">SHOES</a></li>
                                                    <li><a href="#">SPORTS & LIFESTYLE</li>
					...
					<li class="col-sm-2">
						...
						<ul>
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Jewelry & Watches <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
				<ul class="dropdown-menu mega-dropdown-menu">
					<li class="col-sm-3">
					...
					<li class="col-sm-2">
						...
						<ul>
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Bags & Shoes <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
				<ul class="dropdown-menu mega-dropdown-menu">
					<li class="col-sm-3">
					...
					<li class="col-sm-2">
						...
						<ul>
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Toys, Kids & Baby <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
				<ul class="dropdown-menu mega-dropdown-menu">
					<li class="col-sm-3">
					...
					<li class="col-sm-2">
						...
						<ul>
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Sports & Outdoors Wears <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
				<ul class="dropdown-menu mega-dropdown-menu">
					<li class="col-sm-3">
					...
					<li class="col-sm-2">
						...
						<ul>
                            ...
                            <li class="dropdown mega-dropdown relative f_xs_none m_xs_bottom_5">
                                <a href="#" class="dropdown-toggle tr_delay_hover color_light" data-toggle="dropdown">
                                    <b>Much More  <span class="caret"></span></b>
                                </a>
                                <!--sub menu-->
				<ul class="dropdown-menu mega-dropdown-menu">
					<li class="col-sm-3">
