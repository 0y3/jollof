                    ...
                    <ul class="nav navbar-nav-custom pull-right">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="<?= base_url()?>assets/uploads/rest_logo/<?= $rest_data->logo ?>" alt="<?= $rest_data->companyname ?>"> <i class="fa fa-angle-down"></i>
                            ...
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                ...
                                <li>
                                    ...
                                    <a href="<?= site_url('restaurant-admin/profile')?>">
                                ...
                                <li>
                                    ...
                                    <a href="<?= site_url('restaurant-admin/logout')?>"><i class="fa fa-sign-out fa-fw pull-right"></i> Logout</a>
