                                ...
                                <div class="row m-t-40">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        ...
                                        <div class="card card-hover">
                                            <div class="box bg-dark text-center">
                                                ...
                                                <h6 class="text-white">All B2Cc's Count</h6>
                                            </div>
                                        </div>
                                        </a>
                                    </div> 
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/customers?status=0")?>">
                                        <div class="card card-hover">
                                            <div class="box bg-warning text-center">
                                                <h1 class="font-light text-white"><?=number_format(@$pending)?></h1>
                                                <h6 class="text-white">Pending B2C's</h6>
                                            </div>
                                        </div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/customers?status=1")?>">
                                        <div class="card card-hover">
                                            <div class="box bg-success text-center">
                                                <h1 class="font-light text-white"><?=number_format(@$approved)?></h1>
                                                <h6 class="text-white">Approved B2C's</h6>
                                            </div>
                                        </div>
                                        </a>
                                    </div>
                                    ...
                                    <table id="zero_config" class="table table-bordered">
                                        ...
                                        <tbody>
                                        	...
                                        	<?=form_open("jollofadmin/customers/",' id="serachform"')?>
                                                ...
                                                <td>
                                                    <select name="gender" id="" class="form-control" onchange="this.form.submit()">
                                                ...
                                                <td></td>
                                                <td></td> 
                                                <td><input type="number" id="" name="point" class="form-control" placeholder="Search by User Points"></td> 
                                                <td>
