                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $recentorder['ordercode'] ?></td>
                                            <td>
                                                <label class="label label-<?=$status?>"><?= $recentorder['orderstatus_desc'] ?></label>
                                            </td>
                                            <td><?=date("M d, Y", strtotime($recentorder['createdat']))?></td>
                                            <td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable ps-container ps-theme-default ps-active-y" style="height:560px;" data-ps-id="b9bd9161-0be1-ab41-352d-79acf24e0939">
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                ...
                                <!-- Comment Row -->
                            <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; right: 3px; height: 560px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 441px;"></div></div></div>
                        </div>
                    </div>
                    <!-- column -->
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable position-relative ps-container ps-theme-default ps-active-y" style="height:475px;" data-ps-id="6f1fc443-6533-8700-7f4a-3f8e47c71c9c">
                                    <!--chat Row -->
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                ...
                                <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; right: 3px; height: 475px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 427px;"></div></div></div>
                            </div>
