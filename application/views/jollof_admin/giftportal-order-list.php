                                ...
                                <div class="row m-t-40">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/giftportal/orders")?>">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/giftportal/orders?orderstatus=1")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/giftportal/orders?orderstatus=2")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/giftportal/orders?orderstatus=3")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/giftportal/orders?orderstatus=4")?>">
                                        <div class="card card-hover">
                                    ...
                                    <div class="col-md-6 col-lg-2 col-xlg-2">
                                        <a href="<?= site_url("jollofadmin/giftportal/orders?orderstatus=5")?>">
                                        <div class="card card-hover">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                        	<?=form_open("jollofadmin/giftportal/orders/",' id="serachform"')?>
                                                
                                                <td><input type="text" id="createdat" name="createdat" class="form-control" hidden="" placeholder="Search by date"> </td>
                                                                
                                                
                                                <td>
                                                    <input type="text" id="" name="giftportalordercode" class="form-control" placeholder="Search by order code">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" id="giftportalproductname" name="giftportalproductname" class="form-control" placeholder="Search product name">
                                                </td>

                                                <td></td>
                                                <td></td>
                                                <td>
                                                    <select name="giftportalorderstatus" id="" class="form-control" onchange="this.form.submit()">
                                        	   ...
                                        	   if(isset($orderitems) && count($orderitems)>0)
                                        	   {
                                        	       ...
                                        	       foreach ($orderitems as $orderitem)
                                        	       {
                                                           if($orderitem['status']==1)
                                                            {
                                                                $action="";
                                                                if($this->session_manager->hasPermission("Giftportal::index"))
                                                                {
                                                                    $action .='
                                                                ...
                                                                {
                                                                    $action .='
                                                                        <a href="'.site_url("jollofadmin/giftportal/cancel_orderform").'" id="ord_can" data-get="'.$orderitem['id'].'" data-orderid="'.$orderitem['ordercode'].'" data-toggle="modal"  data-target="#modal_cancel" data-container="modal_cancel" title="Cancel Order" class="ord_can btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                                                        ';
                                                                }
                                                                $status="warning";
                                                                /*
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="<?= site_url('jollofadmin/giftportal/ordersview/'.$orderitem['id'])?>" ><?=$orderitem['ordercode']?></a>
                                                </td>
                                                <td><a href="#" class="font-bold link"><?=$orderitem['account_firstname']?> <?=$orderitem['account_lastname']?></a></td>
                                                <td><?=$orderitem['productname']?></td>
                                                <td><?=$orderitem['quantity']?></td>
                                                <td>
                                                    <b> <?= number_format(floatval( $orderitem['point']  ), 2,'.', ',')?>
