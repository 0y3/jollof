                        ...
                        <div>
                            <div class="d-flex no-block align-items-center">
                                <h6 class="card-title">Gift Porter Products List</h6>
                                <div class="ml-auto">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-info" data-toggle="dropdown" 
                                            aria-haspopup="true" aria-expanded="false" onclick="window.location='<?=site_url("jollofadmin/giftportal/addform")?>'">
                                            Create New
                                        </button>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <?=form_open("jollofadmin/giftportal/",' id="serachform"')?>
                                    <td></td>

                                    <td>
                                        <select name="companyname" id="" class="form-control" onchange="this.form.submit()">
                                            <option value="">Admin Search</option>
                                            <option value="all">All Admin</option>
                                            <?php 
                                                foreach ($productsAdmin as $row)
                                                {
                            ...
                            <?php if(!empty($products)): ?>   
                                ...
                                <?php foreach ($products as $product) :?>
                                    ...
                                    <?php
                                        ...
                                        $jpoints = '<div class="text-center"> <b>'.number_format($product['jpoints']).'<b></div>';
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?=site_url("jollofadmin/giftportal/editform/$product[id]")?>" ><?=$product['productname']?></a></td>
                                    <!--<td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?=site_url("giftportal/product/$product[slug]")?>" 
                                        ...
                                        <?php endif; ?>     
                                        <a href="<?=site_url("jollofadmin/giftportal/editform/$product[id]")?>" data-toggle="tooltip" 
                                            title="Edit Product" class="jboxtooltip btn btn-xs btn-warning"> <i class="fa fa-edit"></i></a>
                                            
                                            
                                        <a href="<?=site_url("jollofadmin/giftportal/delete/$product[id]")?>" id="<?=$product['id']?>" 
