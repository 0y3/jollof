...
<form id="product_form" action="<?= site_url('jollofadmin/giftportal/edit/'.$productid) ?>" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="el-overlay">
                                                                <ul class="list-style-none el-info">
                                                                    <li class="el-item">
                                                                        ...
                                                                        <a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?= site_url('assets/uploads/fashion_prod/'.$products['productfrontimage'])?>"><i class="sl-icon-magnifier"></i>
                                                                        </a>

                                                                        <?php elseif (!empty($products['product_image'])): ?>

                                                                        <a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?= site_url('assets/uploads/fashion_prod/'.$products['product_image'][0]['imagename'])?>"><i class="sl-icon-magnifier"></i>
                                                                        </a>

                                                                        <?php else: ?>

                                                                        <a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?= site_url('assets/img/product_img_1.jpg')?>"><i class="sl-icon-magnifier"></i>
                                                                        </a>
                                            ...
                                            <div class="col-md-9">
                                                <div class="">
                                                    <fieldset class="form-group">
                                                        <a class="btn" href="<?= site_url('jollofadmin/giftportal/newimage_form') ?>" data-toggle="modal" data-tooltip="tooltip" data-target="#modal_imagee" data-container="modal_image" title="Add New Image"><i class="fa fa-upload"></i> <b>Upload Image</b></a>
                                                            ...
                                                            <table id="file_export" class="table table-bordered nowrap display">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>Color Name</th>
                                                                        <th>Size</th>
                                                                        <th style="min-width:105px;">J-Points</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0);" data-toggle="tooltip" title="Edit Product J-Points" class="editprice" data-_id="<?= $product_variant['id']?>" data-_varianttype="price" data-_variant="<?= $product_variant['jpoints']?>"><i class="ti-pencil-alt"></i></a> &nbsp; <?= $product_variant['jpoints']?>
                                                                        </td>
                                                                        <!--<td>
    ...
    <div class="modal-dialog modal_dialog_edit" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="productimg_form" action="<?= site_url('jollofadmin/giftportal/productimagesave/'.$productid) ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">

                    <input type="hidden"  name="merchant_id" class="form-control" placeholder="" value="<?php if(isset($_SESSION['User_id'])) echo $_SESSION['User_id']?>" readonly="" required >
                    <div class="col-md-12">
...
<!--end Modal -->
        ...
        <!-- Create New Variant Modal -->
                    ...
                    <div class="modal-content">
                        <form id="productInventory_form"  method="post" class="">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    <button type="button" class="btn btn-info"><i class="ti-more text-white"></i></button>
                                    <input type="text" class="form-control cu_phone_js" name="modal_productjpoints" placeholder="Product J-Points " aria-label="no" required="">
                                </div>
                                 <div class="input-group mb-3">
                                    <button type="button" class="btn btn-info"><i class="ti-more text-white"></i></button>
            ...
            <div class="modal fade" id="imagethumbs" tabindex="-1" role="dialog" aria-labelledby="imagethumbslabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="" action="<?= site_url('jollofadmin/giftportal/savecolorimage_edit/'.$productid) ?>" method="post" enctype="multipart/form-data">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <input type="hidden"  class="form-control" name="modal_merchantid" value="<?= $_SESSION['User_id']?> ">
                                <input type="hidden"  class="form-control" name="modal_productid" value="<?= $productid ?> ">
