...
<form id="prd_form" action="<?= site_url('jollofadmin/giftportal/add') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">    
                                            ...
                                            <div class="col-md-12 card-body">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Product J-Points</label>
                                                                <div class="input-group mb-3">
                                                                    <div class="input-group-prepend">
                                                                        <span class="input-group-text" id="basic-addon1"><i class="far fa-money-bill-alt"></i></span>
                                                                    </div>
                                                                    <input type="number" id="product-jpoints" name="product_jpoints" class="form-control prd_pri" placeholder="0,000" min="0" required="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--/span-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div id="sortvariant" class="col-md-12 form-horizontal form-bordered var_div" style=" display: none; position: relative;">
                                                                        ...
                                                                        <table id="varanttable" class="table no-border custom_table dataTable no-footer dtr-inline var_table">
                                                                            ...
                                                                            <thead>
                                                                                <tr>                        
                                                                                    ...
                                                                                    <th></th>
                                                                                    <th>Variants</th>
                                                                                    <th style="min-width: 80px !important;">J-Points</th>
                                                                                    <th></th>
                                        ...
                                        <div class="card-body modal_prdimg">
                                            <div class="">
                                                <fieldset class="form-group">
                                                    <a class="btn" href="<?= site_url('jollofadmin/giftportal/newimage_form')?>" data-toggle="modal" data-tooltip="tooltip" data-target="#modal_imagee" data-container="modal_image" title="Add New Image"><i class="fa fa-upload"></i> Upload Image</a>
...
<div class="modal fade" id="modal_imagee" tabindex="-1" role="dialog" aria-labelledby="NEW Image view" aria-hidden="true" >
    ...
    <div class="modal-dialog modal_dialog_edit" role="document" style="display: table;" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="productimg_form" action="<?= site_url('jollofadmin/giftportal/productimagesave') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
