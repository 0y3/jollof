                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center m-b-30">
                                    <h4 class="card-title">All <?=$merchantinfo['companyname']?>  Store Orders</h4>
                                    <div class="ml-auto">
                                        <div class="btn-group">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-bordered nowrap display">
                                        ...
                                        <tbody>
                                            ...
                                            ?>          
                                            <tr>
                                                <td><?=date("M d, Y", strtotime($orderitem['createdat']))?></td>
                                                <td>
                                                    <a href="<?= site_url('jollofadmin/merchants/b2bordersview/'.$merchantinfo['slug'].'/'.$orderitem['id'])?>" id="" data-get="<?=$orderitem['id']?>" data-toggle="tooltip" title="View Order Details">
                                                        <?=$orderitem['ordercode']?>
                                                    </a>
                                                </td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="list-group">
                                    ...
                                    <a href="<?=site_url("jollofadmin/merchants/b2borders/".$merchantinfo['slug'])?>" class="list-group-item active"><i class="ti-target m-r-10"></i> Orders
