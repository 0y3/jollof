...
<div id="cuisinenewproduct" class="col-lg-12 ">
    <form id="product_form" action="<?= site_url('jollofadmin/products/'.$action) ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <a href="" class="btn btn-danger prd_adddelete" data-slug="<?= $merchantinfo['slug']?>" data-product_id="<?= $added_list['id'] ?>" data-product_name="<?= $added_list['childproductname'] ?>" data-parentproduct_id="<?= $added_list['parentproductid'] ?>" data-toggle="tooltip" title="Delete Additional Product" type="button">
            ...
            <div class="modal fade" id="createmodel_addedproduct" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="addedproduct_data" action="" method="post" data-slug="<?= $merchantinfo['slug']?>">
