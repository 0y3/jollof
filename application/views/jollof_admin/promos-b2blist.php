                                ...
                                <div class="table-responsive">
                                    <table id="promo_config" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            <?=form_open("jollofadmin/promos/b2bpromos/",' id="serachform"')?>
