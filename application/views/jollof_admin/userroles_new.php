            ...
            .modal-dialog {
                ...
                margin: 30px auto;
                                ...
                                <?php
                                    ...
                                    { 
                                        $action='updateusersroles';
                                        $savename='Update';
                                    }
                                    else{ 
                                        $action='saveusersroles';
                                        $savename='Save';
                                        
                                    }
                                ?>
                                <form id="cate_form" action="<?= site_url('jollofadmin/'.$role_type.'/'.$action) ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="customRadioInline1" name="status" value="1" class="custom-control-input" required=""  <?php if($roleinfo['status']==1) echo 'checked';?> >
                                                    <label class="custom-control-label  text-success" for="customRadioInline1">Active</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="customRadioInline2" name="status"  required=""  <?php if($roleinfo['status']==0) echo 'checked';?> value="0" class="custom-control-input">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-3 control-label" for="save_name">User Role Type</label>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            ?>
                                            <input type="text" id=""  name="userroletype" class="form-control" placeholder=""  readonly="" value="<?= $role_type ?>"  >
                                            ...
                                            <ul id="WaitMe_city" class="city_ul list-link list-unstyled">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php foreach ($roles as $roles_list) :?>
                                                        <li><span class="moditem<?= $roles_list['moduleID'] ?> "><input type="checkbox" value="<?= $roles_list['moduleID'] ?>" name="module[]" id=""><?= $roles_list['Description'] ?></span></li>
                                                    <?php endforeach;?>
