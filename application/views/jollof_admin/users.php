                                        ...
                                        <div class="ml-auto">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info" data-toggle="dropdown" 
                                                	aria-haspopup="true" aria-expanded="false" onclick="window.location='<?=site_url("jollofadmin/users/addform")?>'">
                                                    Create New
                                                </button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?=site_url("jollofadmin/users/editform/".$user['id'])?>" data-toggle="tooltip" data-get="<?=$user['id']?>" title="Edit" class="btn btn-sm btn-light-info"> <i class="fa fa-edit"></i></a>
                                                    ...
                                                    <a href="<?=site_url("jollofadmin/users/resendactivationemail/".$user['id'])?>" id="" data-toggle="tooltip" data-get="<?=$user['id']?>"  title="Resend Activation Email" class="btn btn-sm btn-default send_email"> <i class="fa fa-envelope"></i></a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php
                                    ...
                                    $(document).on("click",".user_del", function(e){
                                       ...
                                       confirmDialog_cart(msgg, function(){
                                           $('.preloader').css("display", "block");
                                            $.ajax({
                                                    type: "POST",
                                                    url: '<?= site_url('jollofadmin/users/delete') ?>',
                                                    dataType: 'json',
                                                    data: {
                                                            _id: s_Id,
                                                            _name: s_name
