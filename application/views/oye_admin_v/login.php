...
<body class="login-img2-bodyme">
    ...
    <div class="container">
        ...
        <form class="login-form" id="login_form" method="POST" action="<?= base_url() ?>adminoye/login_validation">        
        <div class="login-wrap">
            ...
            <div class="login-blockme ">
                ...
                <h3 >Not a member?<a href="<?=base_url()?>adminoye/signup"> Sign up now</a></h3>				
                <h2>or login with</h2>
                    ...
                    if(data =='logged_inn')
                     ...
                     else
                     {
                ...
                }).done(function(data)
                        {
                            ...
                            {
                                alert('welcome success' + data); 
                                window.location.href='<?php echo base_url() ?>adminoye/dashboard';
