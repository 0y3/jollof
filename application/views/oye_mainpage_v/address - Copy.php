        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="add_form" method="POST" action="<?= base_url() ?>accounts/address_validation"> 
                    ...
                    <textarea class="form-control m_bottom_10" name="address" placeholder="Street Address" rows="1" required=""></textarea>
                    ...
                    <div class="row m_bottom_15">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <input class="form-control m_bottom_15 cu_phone_js" name="cell" placeholder="Phone Number" type="text" required="">
                        </div>
                
                        <div class="col-xs-6 col-md-6">
                    
                           <input class="form-control m_bottom_15 cu_phone_js" name="cell2" placeholder="Moblie Number" type="text">
