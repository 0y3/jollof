                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="width-4">Product Product Total PricePrice</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr class="cart_row_total">
                                                                        ...
                                                                        <div class="m_bottom_5" style="">
                                                                            <h6 class="linkcolor">
                                                                                <a href="javascript:void(0);" data-toggle="tooltip" title="<?=$cart_list["product_name"]?>">
                                                                                    <?php
                                                                                        $merchant_id= $cart_list["restaurant_id"];
                                                                                        ...
                                                                                        $totalpr=$cart_list["product_price"] * $cart_list["quantity"];
                                                                                        $limit = '50';
                                                            ...
                                                            <td class="cart_price_total ">
                                                                <div class="o-pro-subtotal">
                                                                    <span style="display:none;"><?= $cart_list["product_price"] * $cart_list["quantity"] ?></span>
                                                                    <p class="cart_price">₦<?= number_format($cart_list["product_price"] * $cart_list["quantity"] )?></p>
                                                                    <input type="hidden" name="cart_price_total" class="cart_suball_price" value="<?= $cart_list["product_price"] * $cart_list["quantity"]?>">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            <td colspan="2"><b>Layaway Duration in Weeks</b> </td>
                                                            <td colspan="1">
                                                                <select name="layawayduration" id="layaway_duration" class="form-control" required="">

                                                                    <?php if(!empty($layaway)): ?>

                                                                        <option value="">Choose Payment Plan...</option>
                                                                            
                                                                            <?php foreach ($layaway as $cate_list) :?>
                                                                                
                                                                                <?php if( $totalpr >= $cate_list['minorder'] ): ?>
                                                                                    <option value="<?= $cate_list['id'] ?>" data-layawayservicefee="<?= $cate_list['servicefee'] ?>" data-layawaycancellationfee="<?= $cate_list['cancellationfee'] ?>" data-layawaydownpayment="<?= $cate_list['downpaymentpercent'] ?>" data-layawaypaymentplain="<?= $cate_list['paymentplan'] ?>" data-layawaywk="<?= $cate_list['durationweeks'] ?>" value="<?= $cate_list['id'] ?>" ><?= $cate_list['durationweeks'] ?> Weeks </option>
                                                                                <?php endif; ?>
                                                                            <?php endforeach;?>
                                                                        <?php else: ?>

                                                                            <option > Payment Plain not available</option>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">Product Total Price </td>
                                                        ...
                                                        <tr >
                                                            <td colspan="2">Cancellation Fee</td>
                                                            <td colspan="1">₦<span class="cancellationfee2">0</span></td>
                                                            <span class="cancellationfee" style=" display: none;"></span>
                                                        </tr>

                                                        <tr >
                                                            <td colspan="2">Service Fee</td>
                                                            <!--<td colspan="1"><span class="smalltext"><span class="fontbold servicefee2">0</span> of ₦<?= number_format($totalpr,2)?> = </span>₦<span class="servicefeeprice">0</span></td>-->
                                                            <td colspan="1">₦<span class="servicefeeprice">0</span></td>
                                                            <span class="servicefee" style=" display: none;"></span>
                                                        </tr>

                                                        <tr >
                                                            <td colspan="2">Payment Plain & Fee</td>
                                                            <td colspan="1"><span class="paymentplain2">0</span> x ₦<span class="paymentplainfee2">0</span></td>
                                                            <span class="paymentplain" style=" display: none;"></span>
                                                            <span class="paymentplainfee" style=" display: none;"></span>
                                                        </tr>

                                                        <tr >
                                                            <td colspan="2"><b>Total layaway Payment</b></td>
                                                            <td colspan="1">₦<span class="totallayawaypayment2">0</span></td>
                                                            <span class="totallayawaypayment" style=" display: none;"></span>
                                                        </tr>

                                                        <tr><td colspan="2">VAT</td>
                                                            <td colspan="1"><span class="smalltext"><span class="fontbold cart_vat"><?=$vat?></span>% of ₦<?= number_format($totalpr,2)?> </span>= ₦<span class="cart_vatfee">0</span> </td>
                                                            <input type="hidden" name="stakle" class="stakle" value="0">
                                                        </tr>

                                                        <tr>
                                                            <td colspan="2">Down Payment Total</td>
                                                            <td colspan="1"><span class="downcal smalltext"></span> =  ₦<span class="cart_price_grandtotal2"></span></td>
...
<form class="form-horizontal" method="post" id="payment_forms" action="<?= site_url('checkout/layawaypayment')?>">
    <input type="hidden" readonly="" class="" name="merchant_id" value="<?= $merchant_id?>">
    ...
    <input type="hidden" readonly="" class="" name="product_price" value="<?= $totalpr?>">
    <input type="hidden" readonly="" class="durationweeks_input" name="durationweeks" value="">
    <input type="hidden" readonly="" class="cancellationfee_input" name="cancellationfee" value="">
    <input type="hidden" readonly="" class="servicefee_input" name="servicefee" value="">
    <input type="hidden" readonly="" class="servicefeepercent_input" name="servicefeepercent" value="">
    <input type="hidden" readonly="" class="paymentplain_input" name="paymentplain" value="">
    <input type="hidden" readonly="" class="amoutperpaymentplain_input" name="amoutperpaymentplain" value="">
    <input type="hidden" readonly="" class="totallayawayprice_input" name="totallayawayprice" value="">
...
$("[data-toggle='modal']").click(function(e) {
 ...
 <script>
    ...
    $(document).ready(function() {
        ...
        var addcityID = $('#add_option :selected',this).data('cityid');
        ...
        var cart_vatfee  = parseFloat((totalpr * $vat / 100 ).toFixed(2));
        $('.cart_vatfee').text(cart_vatfee.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,') );
        ...
        $('#layaway_duration').on('change',function(){

        var layID = $(this).val();
        var $grand_price=0;
        var $vat = parseFloat($('.cart_vat').text());
        var layawayservicefee       = $('option:selected',this).data('layawayservicefee');
        var layawaycancellationfee  = $('option:selected',this).data('layawaycancellationfee');
        var layawaydownpayment      = $('option:selected',this).data('layawaydownpayment');
        var layawaypaymentplain     = $('option:selected',this).data('layawaypaymentplain');
        var layawaywk               = $('option:selected',this).data('layawaywk');

        //percentage calculation
        //var servicefeeprice  = parseFloat((totalpr * layawayservicefee / 100 ).toFixed(2));

        var servicefeeprice  = parseFloat((layawayservicefee ).toFixed(2));

        var totallayawaypayment = parseFloat(totalpr)+parseFloat(servicefeeprice);

        var paymentplainfee = (totallayawaypayment/layawaypaymentplain).toFixed(2);


        $('.durationweeks_input').val(layawaywk);

        $('.cancellationfee2').text(layawaycancellationfee.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
        $('.cancellationfee').text(layawaycancellationfee);
        $('.cancellationfee_input').val(layawaycancellationfee);

        $('.servicefee').text(layawayservicefee);
        $('.servicefee2').text(layawayservicefee);
        $('.servicefeeprice').text(servicefeeprice.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,') );
        $('.servicefee_input').val(servicefeeprice);
        $('.servicefeepercent_input').val(layawayservicefee);


        $('.paymentplain2').text(layawaypaymentplain);
        $('.paymentplain').text(layawaypaymentplain);
        $('.paymentplainfee2').text(paymentplainfee.replace(/\d(?=(\d{3})+\.)/g, '$&,') );
        $('.paymentplainfee').text(paymentplainfee);
        $('.paymentplain_input').val(layawaypaymentplain);
        $('.amoutperpaymentplain_input').val(paymentplainfee);

        $('.totallayawaypayment2').text(totallayawaypayment.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
        $('.totallayawaypayment').text(totallayawaypayment);
        $('.totallayawayprice_input').val(totallayawaypayment);

        $('.downcal').text( '(vat)'+ cart_vatfee.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,') +' +  (payment plan fee)' + paymentplainfee.replace(/\d(?=(\d{3})+\.)/g, '$&,'));
        var $sub_grand = parseFloat($('.cart_price_sub_grandtotal').text());
        $vat = parseFloat(($sub_grand * $vat / 100 ).toFixed(2));
        var stakle = parseFloat(($sub_grand * 8 / 100 ).toFixed(2));
        //alert(stakle);
        $('.stakle').val(stakle);
        $grand_price = parseFloat(paymentplainfee)+parseFloat($vat);
        
        //var grand_priceformat=($grand_price).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
        $(".cart_price_grandtotal").text($grand_price.toFixed(1));
        $(".cart_price_grandtotal2").text($grand_price.toFixed(1).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
                ...
                // Logic
                    ...
                    $.ajax({
                        ...
                        success:function(html){
                            ...
                            fee2 = parseFloat($('.deliv_store_fee'+restID).val());
                        ...
                        complete: function(html) {
                            if (index!=null) {
                                ...
                                if(isNaN(fee2))
                                {
                                    ...
                                    $('.deliv_grandtotal').text(fee2.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
                                    $('.deliv_total_fee').val(fee2);
                                    //grand_price= $grand_price+overall;
                                   // parseFloat($("input[name='deliv_grandtotal']").val(overall.toFixed(2)));
                                   grand_price= $grand_price+fee2;
                                   grand_price=grand_price.toFixed(1);
                                   
                                   //var grand_priceformat=($grand_price).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                                    $(".all_price_grandtotal").text(grand_price);
                                    $(".all_price_grandtotal2").text(grand_price.replace(/\d(?=(\d{3})+\.)/g, '$&,') );
                                   //alert(grand_price);
    ...
    $('#add_option').on('change',function(){
            ...
            var overall=0;
            var addID = $(this).val();
            addcityID = $(':selected',this).data('cityid');
