    ...
    <div class="<?= $row['id']; ?> margin-bottom-2" style="border: 1px solid #d1d4d7;">
        ...
        <div class="or_infoo">
            <ul>
                ...
                <li >
                    <span class="li_bold">Additional charges = </span> <span class="fontred"><?= $row['addcharge']; ?></span> 
                </li>
                
                <li >
                    <span class="li_bold"> discount = </span> <span class="fontred"><?= $row['discount']; ?></span> 
                </li>
                
            </ul>
            <div>
                <span class="text-bold">Grand Price = </span> <span class="fontred">₦<?= $row['total']; ?></span> 
            </div>
            
        </div>
        
        <?php foreach ($row['products_order'] as $row_prd) :?>
        
            <?php
        
                $bg =null;
                $status_id=$row_prd['status_id'];
                ...
                $moremenu = null;
                if (!empty($row_prd['addedmenu']) )
                    {
                       $moremenu= '<span class="label label-default"> With more menu</span>';
                    }
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 main-card padtop display-flex">
                <div class="col-sm-12 col-md-2 col-lg-2 background-green status <?=$bg;?>">
                    ...
                    <div class="status-id">
                        ...
                        <h4><?= date('jS M \, Y \ g:i A', strtotime($row_prd['date'])); ?></h4>
                    </div>
                </div>
                <div class="col-sm-12 col-md-9 white-card box-shadow display-flex">
                    ...
                    <div class="col-sm-12 col-md-3 padding-top-2 padding-bottom-2 display-inline-grid" style="background: #fafafa;">
                        ...
                        <div>
                           <p class="text-bold margin-bottom-0">Status</p>
                            <p class="margin-bottom-0"><span class="label <?=$lb_bg ;?>"><?= $row_prd['status_desc']; ?></span></p>
                        </div>

                        <div><p class="text-bold margin-bottom-0">Payment Type</p>
                            <p class="margin-bottom-0">
                                <?= $row['deliverytype']; ?> 
                            </p>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-3 padding-top-2 padding-bottom-2 display-inline-grid" style="background: #fafafa;">
                        ...
                        <div>
                            <p class="text-bold margin-bottom-0">Total</p>
                            <p class="margin-bottom-0 fontred">
                                ₦ <span><?= $row_prd['price']; ?> </span> 
                            </p>
                        </div>
                                ...
                                if($status_id == '5'|| $status_id == '4' || $status_id == '1')
                                    {
                                        echo '
                                               <div class="col-md-12 padding-top-1">
                                                    <a id="" class="btn btn-default" href="'. site_url('accounts/order/'.$row_prd['id']).'"> View order</a>
                                                </div>
                                            ';
                                    }
                                else
