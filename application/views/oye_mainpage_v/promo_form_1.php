            ...
            <div class=" form-horizontal form-bordered" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 nopadding">
                        <div class="col-xs-11">
                            <select id="promo_type" name="r_state" class="form-control" style="width: 250px;" required="">
...
$(document).ready(function(){
    ...
    // on Promo Type option click, change Promo image properties
            $('#promo_type').on('change', function() {
                ...
                {
                  $(".banner_UploadView").removeClass('promo_main promo_cuisine_main promo_cuisine_rest').addClass('promo_main');
                  //$(".modal-dialog").addClass('modal_dialog_edit');
                  $(".banner_txt").text('{ 1450px - 500px }');
                
                }
                
                else if ( ($(this).find(':selected').data("promowidth") == 265) &&($(this).find(':selected').data("promoheight")== 430) )
                {
                  $(".banner_UploadView").removeClass('promo_main promo_cuisine_main promo_cuisine_rest').addClass(' promo_cuisine_rest');
                  //$(".modal-dialog").addClass('modal_dialog_edit');
                  $(".banner_txt").text('{ 265px - 430px }');
