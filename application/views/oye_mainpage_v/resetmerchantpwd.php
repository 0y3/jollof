...
<div class="container">
    ...
    <div class="col-xs-12 col-md-6 offset-md-3 ">
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
    <form class="form-horizontal" id="resetpwd_form" name="resetpwdForm" method="POST" action="<?= site_url('accounts/merchantpassword')?>" > 
        ...
        $('#cfmpwd').on('keyup', function () {
            ...
            $("#resetpwd_form").submit(function (e){
                ...
                { 
                    ...
                    var loginurl = '<?= $merchantinfo['merchanttype'] ?>admin';
                    ...
                    }).done(function(data)
                            {
                                ...
                                { 
                                        new jBox('Notice', {
                                          ...
                                          setTimeout(function(){
                                            window.location.href = '<?= site_url('') ?>'+loginurl;
                                         }, 3000);
