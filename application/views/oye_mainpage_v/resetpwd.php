...
<div class="container">
    ...
    <div class="col-xs-12 col-md-6 offset-md-3 ">
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
    <form class="form-horizontal" id="resetpwd_form" name="resetpwdForm" method="POST" action="<?= site_url('accounts/save_resetpwd')?>" > 
                    ...
                    }).done(function(data)
                            {
                                ...
                                { 
                                        new jBox('Notice', {
                                          ...
                                          setTimeout(function(){
                                            window.location.href = '<?= site_url('accounts/login') ?>';
                                         }, 3000);
