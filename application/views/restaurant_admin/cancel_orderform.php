                    ...
                    <div class="modal-dialog modal-width" style=" margin-top: 60px;">
                        ...
                        <div class="modal-content modal-center">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="cate_form" action="<?= site_url('restaurant_admin/update_order_flow') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                ...
                }).done(function(data)
                        {
                            ...
                            if(data.status === '1' )
                            {
                                ...
                                window.setTimeout(function () {
                                    location.href = "<?php echo site_url('restaurant-admin/order_pending'); ?>";
                                }, 2000);
