                                ...
                                <form id="cate_form" action="<?= site_url('restaurant_admin/merchantslidersave') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-12">
                                           ...
                                           <div class="banner_UploadView ">
                                               ...
                                               <img class="img-responsive UploadView_banner" src="https://placeholdit.co//i/500x200?bg=BDBDBD" width="100%" height="100%" />
                                    ...
                                    <div class="form-group form-actions">
                                        ...
                                        <div class="col-md-12 col-md-offset-33 div_reset">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-primary sbmtbtn"><i class="fa fa-floppy-o"></i> &nbsp; Save &nbsp; </button>
...
-->
        ...
        <script>
            ...
            $('#slider_type').on('change', function() {
                ...
                {
                  $(".banner_UploadView").removeClass('slider_homebanner slider_homecenter slider_resslider').addClass('slider_homebanner');
                ...
                {
                  $(".banner_UploadView").removeClass('slider_homebanner slider_homecenter slider_resslider').addClass(' slider_resslider');
                  $(".modal-dialog").addClass('modal_dialog_edit');
