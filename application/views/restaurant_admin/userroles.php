                    ...
                    <div class="block full">
                        ...
                        <div class="block-title">
                            ...
                            <div class="block-options pull-right">
                                ...
                                <a href="<?= site_url('restaurant_admin/loaduserrole') ?>" class="btn btn-sm btn-default" data-toggle="modal" data-tooltip="tooltip" data-target="#modal_cate" data-container="modal_cate" title="Add New Slider " style="background-color:#1bbae1; color: #FFF">
...
<script >
      ...
      var dataTable = $('#order_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= site_url('restaurant_admin/userrole_table'); ?>",
                type:"POST"
           },  
           "columnDefs":[  
                {  
...
<script>
    ...
    $('.selectstatus').on('change',function(){
            ...
            if(statusID){
                $.ajax({
                    type:'POST',
                    url:'<?= site_url('restaurant_admin/update_userroles_status') ?>',
                    dataType: 'json',
                    data:{
                            status:statusID,
                            cat_id:cat_id_
