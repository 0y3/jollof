...
<style>
    td{
                    ...
                    <?php $this->load->view('super_admin/b2bthridpartyads_nav_tray'); // Restaurants tray ?>
                    </div>
                    ...
                    <div class="block full">
                        ...
                        <div class="block-title">
                            ...
                            <h2><strong>Approved Third Party</strong> ADs Display Review</h2>
...
<script >
      ...
      var dataTable = $('#order_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= site_url('super_admin/b2bthridpartyads/1'); ?>",
                type:"POST"
           },  
           "columnDefs":[  
                {  
            ...
            $.ajax({
                ...
                success:function(html){
                    ...
                    if(html.status == '1')
                    {
                        ...
                        $('.rest_nav_tray').load("<?= site_url('super_admin/b2bthridpartyads_nav_tray') ?>");
                    }
                    else{ noticefales(); }
                }
