                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a href="b2corder_pending" class="widget widget-hover-effect2">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a href="b2corder_processing" class="widget widget-hover-effect2">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div href="b2corder_delivered" class="widget widget-hover-effect2">
                                ...
                                <div class="widget-extra-full">
                                    <a href="b2corder_delivery" data-toggle="tooltip"  title="View Disperse Order">
                                    ...
                                    <a href="b2corder_delivered" data-toggle="tooltip"  title="View Delivered Order" class="">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a href="b2corder_cancel" class="widget widget-hover-effect2">
