...
<style>
    td{
                    ...
                    <?php $this->load->view('super_admin/cuisine_slider_nav_tray'); // Restaurants tray ?>
                    </div>
                    ...
                    <div class="block full">
                        ...
                        <div class="block-title">
                            ...
                            <h2><strong>Cuisine Restaurant Sidebar</strong> Promos Management</h2>
                            
                            <div class="block-options pull-right">

                                <a href="<?= site_url('super_admin/cuisine_slider_new') ?>" class="btn btn-sm btn-default" data-toggle="modal" data-tooltip="tooltip" data-target="#modal_cate" data-container="modal_cate" title="Add New Slider " style="background-color:#1bbae1; color: #FFF">
                                    <i class="fa fa-plus-circle"></i>&nbsp;Add Promo Slider
                                </a>
                        ...
                        <table id="order_datatable" class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <thead style=" width:100%; ">
                                ...
                                <tr>
                                    ...
                                    <th class="" style="width: 30 !important;" >Redirect Url</th>
...
<script >
      ...
      var dataTable = $('#order_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= site_url('super_admin/cuisine_slider_home/3'); ?>",
                type:"POST"
           },  
           "columnDefs":[  
                {  
...
<script>
    ...
    $('.selectstatus').on('change',function(){
            ...
            if(statusID){
                $.ajax({
                    type:'POST',
                    url:'<?= site_url('super_admin/update_cuisine_slider_status') ?>',
                    dataType: 'json',
                    data:{
                            status:statusID,
                            cat_id:cat_id_
...
<script>
    ...
    $('#cat_order_save').click(function (e) {
            ...
            var cat_id_   = $('[name="new_cat_order"]').data('cat_id'); // gets value
                ...
                $.ajax({
                    type:'POST',
                    url:'<?= site_url('super_admin/update_cuisine_slider_cate') ?>',
                    dataType: 'json',
                    data:{
                            order:new_order,
                            cat_id:cat_id_
