                    ...
                    <div class="modal-dialog modal-width " style=" margin-top: 60pxx; ">
                        ...
                        <div class="modal-content modal-center" style="">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="cate_form" action="<?= site_url('super_admin/cuisineslidersave') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
    ...
    $('input[id=file]').change(function() {
        ...
        //$('#fake-input_banner').val($(this).val().replace("C:\\fakepath\\", ""));
            ...
            $('#slider_type').on('change', function() {
                ...
                {
                  $(".imageBox").removeClass('promomaincover promocuisinemaincover promocuisinerestcover');
                  $(".thumbBox ").removeClass('promomain promocuisinemain promocuisinerest');
                  $(".modal-dialog").removeClass('modal_dialog_edit');
                  $(".banner_txt").text('');
                  Removecrop_banner();
