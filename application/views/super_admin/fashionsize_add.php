                    ...
                    <div class="modal-dialog modal-width" style=" margin-top: 60px;">
                        ...
                        <div class="modal-content modal-center">
                            ...
                            <div class="modal-header mod-head" >
                                ...
                                <h3 class="modal-title text-left"><b>New Size Form </b></h3>
                
                            </div>
                            
                            <div class="modal-body">
                  
                                <form id="cate_form" action="<?= site_url('super_admin/fashionsizeadd') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <input type="text" id="save_name"  name="save_name" class="form-control" placeholder="Enter Size Name.." value="" required="">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <input type="text" id="save_code"  name="save_code" class="form-control" placeholder="Enter Size Code.." value="" required="">
                ...
                }).done(function(data)
                        {
                            ...
                            if(data.status === '1' )
                            {
                                ...
                                $('#modal_sub_cate').modal('hide'); 
                                    ...
                                    content: 'Success! Size Name: '+$('#save_name').val()+' Added',
                                    delayOnHover: true,
                                    showCountdown: true,
                                    closeButton: true
                                });
                                ...
                                //window.location.href = "<?php echo site_url('admin/fashionsize'); ?>";
                            }
