                    ...
                    <div class="modal-dialog modal-width" style=" margin-top: 60px;">
                        ...
                        <div class="modal-content modal-center">
                            ...
                            <div class="modal-header mod-head" >
                                ...
                                <h3 class="modal-title text-left"><b>New Size Category </b></h3>
                
                            </div>
                            
                            <div class="modal-body">
                  
                                <form id="cate_form" action="<?= site_url('super_admin/fashionsizecategoryadd') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                ...
                }).done(function(data)
                        {
                            ...
                            if(data.status === '1' )
                            {
                                ...
                                $('#modal_cate').modal('hide'); 
                                    ...
                                    content: 'Success! Size Category Name: '+$('#save_name').val()+' Added',
                                    delayOnHover: true,
                                    showCountdown: true,
                                    closeButton: true
                                });
