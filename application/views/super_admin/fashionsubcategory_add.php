                    ...
                    <div class="modal-dialog modal-width" style=" margin-top: 60px;">
                        ...
                        <div class="modal-content modal-center">
                            ...
                            <div class="modal-header mod-head" >
                                ...
                                <h3 class="modal-title text-left"><b>New Sub Category </b></h3>
                
                            </div>
                            
                            <div class="modal-body">
                  
                                <form id="cate_form" action="<?= site_url('super_admin/fashionsubcategoryadd') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                   ...
                   data:data
                }).done(function(data)
                        {
                            ...
                            if(data.status === '1' )
                            {
                                ...
                                //window.location.href = "<?php echo site_url('admin/fashioncategory'); ?>";
                            }
