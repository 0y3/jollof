...
<!-- Modal -->
                    ...
                    <div class="modal-dialog modal-width" style=" margin-top: 60px;">
                        ...
                        <div class="modal-content modal-center">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="cate_form" action="<?= site_url('super_admin/fashionsubcategoryupdate') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-3 control-label" for="save_name">Sub Category Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row m_bottom_15">
                                            <div class="col-xs-4 col-xs-offset-2">
                                                ...
                                                <input type="number" id="sub_sort" class="form-control" name="sub_sort" min="0" value="<?=$data_subcate[0]->arrangecategory?>">
                                            </div>
                                            ...
                                            <div class="col-xs-6 ">
                                                ...
                                                <div class="col-md-99">
                                                    ...
                                                    <label class="switch switch-primary">
                                                        ...
                                                        <input type="checkbox" name="sub_status" id="sub_status" <?php echo $data_subcate[0]->status == 1 ? 'checked' : ''  ?>><span></span>
        ...
        <script>
            ...
            $("#cate_form").submit(function (e){
                ...
                var _cateId = $('[name="parent_category"]').val();
