...
<style>
    td{
                    ...
                    <?php $this->load->view('super_admin/jollof_slider_nav_tray'); // Restaurants tray ?>
                    </div>
                    ...
                    <div class="block full">
                        ...
                        <div class="block-title">
                            ...
                            <h2><strong>Jollof Homepage Banner</strong> Sliders Management</h2>
                            
                            <div class="block-options pull-right">

                                <a href="<?= site_url('super_admin/cuisine_slider_new') ?>" class="btn btn-sm btn-default" data-toggle="modal" data-tooltip="tooltip" data-target="#modal_cate" data-container="modal_cate" title="Add New Category" style="background-color:#1bbae1; color: #FFF">
                                    <i class="fa fa-plus-circle"></i>&nbsp;Add Banner Slider
                                </a>
...
<script >
      ...
      var dataTable = $('#order_datatable').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?= site_url('super_admin/cuisine_slider_home/4'); ?>",
                type:"POST"
           },  
           "columnDefs":[  
                {  
