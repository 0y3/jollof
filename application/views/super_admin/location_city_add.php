                    ...
                    <div class="modal-dialog modal-width" style=" margin-top: 60px;">
                        ...
                        <div class="modal-content modal-center">
                            ...
                            <div class="modal-header mod-head" >
                                ...
                                <h3 class="modal-title text-left"><b>New City </b></h3>
                
                            </div>
                            
                            <div class="modal-body">
                  
                                <form id="loc_form" action="<?= site_url('super_admin/save_location_city') ?>" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-3 control-label" for="">State Name</label>

                                        <div class="col-md-7">

                                            <select id="" name="state_id" class="form-control selectpicker" data-live-search="true" show-tick  data-size="8" title="Choose State" data-width="90%" required="">
                                                    <?php if(!empty($state)): ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-3 control-label" for="save_name">City Name</label>

                                        <div class="col-md-7">

                                            <input type="text" id="save_name"  name="city_name" class="form-control" placeholder="Enter name.." value="" required="">
                ...
                }).done(function(data)
                        {
                            ...
                            if(data.status === '1' )
                            {
                                ...
                                $('#modal_cate').modal('hide'); 
                                    ...
                                    content: 'Success! Location Name: '+_Name+' Added',
                                    delayOnHover: true,
                                    showCountdown: true,
                                    closeButton: true
                                });
