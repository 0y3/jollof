...
<body class="login-img2-bodyme">
    ...
    <div class="container">
        ...
        <form class="login-form" id="login_form" method="POST" action="<?= site_url('admin/login_validation') ?>">        
        <div class="login-wrap">
            <h2 class="text-center login-imgme"> Admin Login<i class="icon_lock_alt login_imgme_icon"></i></h2>
