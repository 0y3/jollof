...
var App = function() {
    var a, e, i, s, t, l, n, o, r = function() {
            a = $("#page-container"), e = $("#page-content"), i = $("header"), s = $("#page-content + footer"), t = $("#sidebar"), l = $("#sidebar-scroll"), n = $("#sidebar-alt"),
                o = $("#sidebar-alt-scroll"), b("init"), h(), p(), m(), v();
            var r = $("#year-copy"),
                d = new Date;
            2017 === d.getFullYear() ? r.html("2017") : r.html("2017-" + d.getFullYear().toString().substr(2, 2)), f(), $('[data-toggle="tabs"] a, .enable-tabs a').click(function(a) {
        ...
        h = function() {
            ...
            s.click(function() {
                var s = $(this);
                return a.hasClass("sidebar-mini") && a.hasClass("sidebar-visible-lg-mini") && c() > 991 ? s.hasClass("open") ? s.removeClass("open").next().removeAttr("style") : (
                    $(".sidebar-nav-menu.open").removeClass("open").next().removeAttr("style"), s.addClass("open").next().css("display", "block")
                ) : s.parent().hasClass("active") || (s.hasClass("open") ? (s.removeClass("open").next().slideUp(e, function() {
                    u(s, 200, 300)
                }), setTimeout(g, e)) : (
                    $(".sidebar-nav-menu.open").removeClass("open").next().slideUp(e), s.addClass("open").next().slideDown(i, function() {
                        u(s, 150, 600)
                ...
                return a.parent().hasClass("active") !== !0 && (a.hasClass("open") ? (a.removeClass("open").next().slideUp(e, function() {
                    u(a, 200, 300)
                }), setTimeout(g, e)) : (a.closest("ul").find(".sidebar-nav-submenu.open").removeClass("open").next().slideUp(e),
                    a.addClass("open").next().slideDown(i, function() {
                        u(a, 150, 600)
        ...
        b = function(e, i) {
            if ("init" === e) b("sidebar-scroll"),
                b("sidebar-alt-scroll"), $(".sidebar-partial #sidebar").mouseenter(function() {
                    b("close-sidebar-alt")
